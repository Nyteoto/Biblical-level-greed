...
Say '3/6  Data'
# The repo holds the app, not what you write in it, so `data\` is created
# here rather than arriving with the clone. There is nothing to seed — the six
...
# with no arguments should still start.
New-Item -ItemType Directory -Force -Path data\capture\log, data\media | Out-Null
OK 'data\ ready'
...
$shortcut.Description = 'Trophic - syntax-driven capture'
$shortcut.Save()
